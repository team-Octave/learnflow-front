// src/features/lectures/components/main/LectureCard.tsx
'use client';
...
// 부모 컴포넌트(MainPage)에서 전달한 lecture 객체를 받음
...
export default function LectureCard({ lecture }: LectureCardProps) {
  ...
  return (
    // 카드 전체를 <Link>로 감싸서 클릭 시 강의 상세 페이지 이동
    // group 클래스는 자식 요소 hover 상태 트리거 용도로 사용
