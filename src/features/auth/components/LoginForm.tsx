  ...
  return (
    <div className="w-full max-w-md bg-[#18181B]/50 border border-[#27272A] rounded-xl p-8 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {error && <p className="text-[#FF6467] text-sm mt-2">{error}</p>}
      ...
      <div className="mt-8 text-center text-sm text-[#A1A1AA]">
        계정이 없으신가요?{' '}
        <a href="/signup" className="text-[#7C86FF] font-semibold">
          회원가입
        </a>
        <div className="mt-3">
          <a href="/" className="text-[#A1A1AA] hover:text-white transition">
            홈으로 돌아가기
          </a>
        </div>
      </div>
